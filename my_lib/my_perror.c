...
** Last update Fri Mar 29 09:47:08 2013 aymeric lambolez
*/
...
{
  if (c == 'd' || c == 'i')
    compteur = my_putnbr_count_e(va_arg(ap, int));
  else if (c == 's')
    compteur = my_putstr_count_e(va_arg(ap, char*));
  else if (c == 'c')
    compteur = my_putchar_count_e(va_arg(ap, int));
  else if (c == '\0')
    ;
  else if (c == 'b')
    compteur = my_putnbr_bin_e(va_arg(ap, int));
  else if (c == '%')
    compteur = my_putchar_count_e('%');
  else if (c == 'S')
    compteur = my_putstr_oct_e(va_arg(ap, char*));
  else if (c == 'o')
    compteur = my_putnbr_oct_e(va_arg(ap, int));
  else if (c == 'x')
    compteur = my_putunnbr_base_e(va_arg(ap, int), base);
  else if (c == 'X')
    compteur = my_putunnbr_base_e(va_arg(ap, int), "0123456789ABCDEF");
  else if (c == 'p')
